                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <a href="mailto:mbutocy@gmail.com" className="text-blue-400 hover:text-blue-800 block">mbutocy@gmail.com</a>
                            <a href="mailto:cm845@cornell.edu" className="text-blue-400 hover:text-blue-800">cm845@cornell.edu</a>
                        </div>
                    </div>

                    {/* LinkedIn Section */}
                    <div className="flex items-start space-x-3">
                        <svg className="w-6 h-6 text-blue-400 mt-1" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                        </svg>
                        <div>
                            <h2 className="text-xl font-semibold mb-2 text-black">LinkedIn</h2>
                            <a 
                                href="https://www.linkedin.com/in/cynthia-mujyambere-26956a233/" 
                                target="_blank" 
